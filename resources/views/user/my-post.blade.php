        ...
        <div class="col-lg-2 col-sm-4 text-center">
            <div class="card">
                ...
                <div class="card-body text-center bg-success-subtle">
                    <a href="#" class="card-link">Mi Perfil</a>
                </div>
            </div>
            <button class="btn btn-info mt-3" data-bs-toggle="modal" data-bs-target="#editarPublicacion"># Editar Publicación</button>
            <button class="btn btn-danger mt-3" data-bs-toggle="modal" data-bs-target="#eliminarPublicacion">- Eliminar Publicación</button>
            @include('components/modals/edit/edit-post')
            @include('components/modals/delete/delete-post')
        </div>
